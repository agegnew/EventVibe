      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="relative rounded-xl overflow-hidden h-[250px] sm:h-[300px] md:h-[400px] mb-6 sm:mb-8">
            <Image src={event?.image || "/placeholder.svg"} alt={event?.title || "Event"} fill className="object-cover" priority />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
              <div className="p-4 sm:p-6 md:p-8 w-full">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2">{event?.title || "Event Details"}</h1>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <GlassmorphicCard className="p-6 md:p-8" borderGlow={true}>
                ...
                <p className="text-gray-700 dark:text-gray-300 whitespace-pre-line">{event?.description || "No description available"}</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                  <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                    ...
                    <div className="font-bold">{event?.registrations || 0}/{event?.seats || 0}</div>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                    ...
                    <div className="font-bold">{event?.price === 0 ? 'Free' : `$${event?.price || 0}`}</div>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                    <Calendar className="w-6 h-6 mx-auto mb-2 text-blue-600 dark:text-blue-400" />
                    <div className="text-sm text-gray-600 dark:text-gray-400">Date</div>
                    <div className="font-bold">{event?.date ? new Date(event.date).toLocaleDateString() : "Date TBA"}</div>
                  </div>
                  <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
                    <MapPin className="w-6 h-6 mx-auto mb-2 text-blue-600 dark:text-blue-400" />
                    <div className="text-sm text-gray-600 dark:text-gray-400">Location</div>
                    <div className="font-bold">{event?.location ? event.location.split(',')[0] : 'Location TBA'}</div>
                  </div>
                </div>
              </GlassmorphicCard>
            </motion.div>
            ...
            >
              <GlassmorphicCard className="p-6 md:p-8" borderGlow={true}>
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-4">{event?.location || 'Location TBA'}</p>
